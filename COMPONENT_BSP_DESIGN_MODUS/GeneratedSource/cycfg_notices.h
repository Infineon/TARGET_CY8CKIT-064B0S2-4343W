...
#ifndef CYB0644ABZI_S2D44
    #error "Unexpected target MCU; expected CYB0644ABZI-S2D44. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
